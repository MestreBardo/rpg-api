    ...
    static schema = Joi.object({
        ...
        password: Joi.string()
            ...
            .messages({
                ...
                "string.min": "Password has less than 6 characters",
        ...
        confirmationPassword: Joi.string()
            ...
            .messages({
                ...
                "any.required": "Confirmation password not found",
                "string.empty": "Confirmation password field is empty",
                "string.min": "Confirmation password has less than 6 characters",
        ...
        birthday: Joi.date()
            .required()
            .messages({
                "any.required": "Birthday not found",
